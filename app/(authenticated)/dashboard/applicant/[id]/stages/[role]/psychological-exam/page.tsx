...
export default async function PsychologicalExamPage({ params }: { params: { id: string } }) {
	...
	// before -> psychological_exam, after -> Psychological Exam
	const currentStageName = applicantStage && "Psychological Exam";
				...
				<CardHeader>
					<CardTitle className="flex justify-between">
						...
						<DownloadForm
							...
							downloadText="Psychological Exam Rating Form"
						>
							Download Teaching Demo Rating Form (download link needs to be updated
							into psychological_exam-rating-form.xlsx)
						</DownloadForm>
					</CardTitle>
				</CardHeader>
