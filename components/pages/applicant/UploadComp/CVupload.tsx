...
export default function CVupload() {
	return (
		<div>
			<div>
				<h1 className="mb-5 text-black">Upload CV/Resume</h1>
			</div>

			<div className="flex h-40 w-full flex-col items-center justify-center rounded-xl border-2 border-dotted border-[#666666]">
				<div className="mb-2">
					<svg
						width="46"
						height="38"
